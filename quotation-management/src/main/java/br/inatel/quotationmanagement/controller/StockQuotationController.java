...
import br.inatel.quotationmanagement.controller.form.StockQuotationForm;
...
//	 }
	...
	@PostMapping
	public ResponseEntity<?> creat(@RequestBody @Valid StockQuotationForm formQuote) {
		StockQuotation quote = formQuote.coverter();
